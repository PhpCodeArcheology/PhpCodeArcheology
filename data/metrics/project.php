...
return [
    ...
    [
        ...
        'name' => 'Grade',
        'shortName' => 'Grade',
        'description' => 'Overall project health grade derived from Health Score: A (≥90 excellent), B (≥80 good), C (≥65 acceptable), D (≥50 poor), F (<50 critical). Based on maintainability, problem density, complexity, coupling, code structure, HTML-in-PHP ratio, encapsulation quality, dependency health, abstractness, and test coverage.',
    ...
    [
        'key' => 'healthScoreVersion',
        'name' => 'Health score version',
        'shortName' => '',
        'description' => 'Version of the health score formula. Used to detect incompatible historical comparisons.',
    ...
    // Test analysis
    [
        'key' => 'overallTestFileCount',
        'name' => 'Test files',
        'shortName' => 'Test Files',
        'description' => 'Total number of test files found in the project.',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Int,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::Irrelevant,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        'key' => 'overallProductionFileCount',
        'name' => 'Production files',
        'shortName' => 'Prod Files',
        'description' => 'Total number of production (non-test) PHP files.',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Int,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::Irrelevant,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        'key' => 'overallTestRatio',
        'name' => 'Test ratio',
        'shortName' => 'Test Ratio',
        'description' => 'Ratio of test files to production files (higher means more test coverage).',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Percentage,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::High,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        'key' => 'overallTestedClassCount',
        'name' => 'Tested classes',
        'shortName' => 'Tested',
        'description' => 'Number of production classes with at least one mapped test.',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Int,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::High,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        'key' => 'overallUntestedClassCount',
        'name' => 'Untested classes',
        'shortName' => 'Untested',
        'description' => 'Number of production classes without any mapped test.',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Int,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::Low,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        ...
        'shortName' => 'Tested %',
        'description' => 'Percentage of production classes that have at least one mapped test.',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Percentage,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::High,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        'key' => 'overallFunctionBasedTestFileCount',
        'name' => 'Function-based test files',
        'shortName' => 'Fn Tests',
        'description' => 'Test files without class declarations (e.g. Pest function-style tests).',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Int,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::Irrelevant,
    ...
    [
        'key' => 'detectedTestFrameworks',
        'name' => 'Detected Test Frameworks',
        'shortName' => 'Test FW',
        'description' => 'Test frameworks auto-detected via composer.json (PHPUnit, Pest, Codeception).',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::String,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::Irrelevant,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
    ...
    [
        'key' => 'overallCoveragePercent',
        'name' => 'Line coverage',
        'shortName' => 'Coverage %',
        'description' => 'Overall line coverage percentage from Clover XML data.',
        'valueType' => \PhpCodeArch\Metrics\Model\Enums\MetricValueType::Percentage,
        'better' => \PhpCodeArch\Metrics\Model\Enums\BetterDirection::High,
        'visibility' => \PhpCodeArch\Metrics\Model\Enums\MetricVisibility::ShowEverywhere,
        'collections' => [
